...
use dod_utils::types::{
    BlockData, BlockDataFull, BlockSigs, BootStrapParams, DodCanisters, Height, MinerBlockData,
    MinerCandidate, MinerInfo, MinerSubmitPayload, MinerSubmitResponse, NewBlockOrderValue,
    OrderStatus, UserBlockOrderRes,
};
use ic_cdk::caller;
use ic_cdk_macros::*;
...
pub async fn claim_dod_to_wallet() -> Result<String, String> {
    match DodService::claim_reward(caller()).await {
